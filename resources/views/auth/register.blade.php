...
@section('content')
    <!--===== BREADCRUMB START =========-->
    <section class="fp__breadcrumb" style="background: url({{ asset('customer/assets/images/counter_bg.jpg') }});">
    ...
    <!--====== SIGN UP START =======-->
    <section class="fp__signup" style="background: url({{ asset('customer/assets/images/login_bg.jpg') }});">
